              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">Douala, Bonanjo
                      <br> 78345
                    </p>
                    <h1 class="intro-title mb-4 ">
                      <span class="color-b">204 </span> route 
                      <br> de DuPoteaux
                    </h1>
          ...
          <div class="table-cell">
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">Yaoundé, rue de l'amitié
                      <br> 78345
                    </p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">204 </span> rue 
                      <br> du chanvre
                    </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="contact.php"><span class="price-a">Contactez-nous</span></a>
          ...
          <div class="table-cell">
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">Douala, rue du bosquet
                      <br> 78345
                    </p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">204 </span> Mbalmayo
                      <br> new town
                    </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="contact.php"><span class="price-a">Contactez-nous</span></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Appartements disponibles</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="assets/equipe/bonj.jpg" alt="membre de l'équipe" class="img-d img-fluid">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">Du Poteaux</h3>
                  </div>
                </div>
                <div class="card-body-d">
                  <p class="content-d color-text-a">
                   Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et corrupti officiis?
                  </p>
                  <div class="info-agents color-a">
                    <p>
                      <strong>Téléphone: </strong> +237 699112031
                    </p>
                    <p>
                      <strong>Email: </strong> rolandddebotho19@gmail.com
                    </p>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              <div class="title-box">
                <h2 class="title-a">Clients satisfaits</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="testimonial-author-box">
                      ...
                      <h5 class="testimonial-author">roland & pouppy</h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonials-box">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="testimonial-author-box">
                      <img src="assets/img/mini-testimonial-1.jpg" alt="" class="testimonial-avatar">
                      <h5 class="testimonial-author">bonjour & bonsoir</h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonials-box">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="testimonial-author-box">
                      <img src="assets/img/mini-testimonial-1.jpg" alt="" class="testimonial-avatar">
                      <h5 class="testimonial-author">beurre & chocolat</h5>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonials-box">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <div class="testimonial-author-box">
                      <img src="assets/img/mini-testimonial-1.jpg" alt="" class="testimonial-avatar">
                      <h5 class="testimonial-author">chambon & saucisson</h5>
                    </div>
                  </div>
                </div>
              </div>
